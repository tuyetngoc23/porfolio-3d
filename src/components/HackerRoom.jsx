...
Files: hacker-room-new.glb [34.62MB] > /porfolio-3d/models/hacker-room-new-transformed.glb [2.56MB] (93%)
*/

import { useGLTF, useTexture } from "@react-three/drei";

const HackerRoom = (props) => {
  const { nodes, materials } = useGLTF("/porfolio-3d/models/hacker-room.glb");

  const monitortxt = useTexture("/porfolio-3d/textures/desk/monitor.png");
  const screenTxt = useTexture("/porfolio-3d/textures/desk/screen.png");
...
useGLTF.preload("/porfolio-3d/models/hacker-room.glb");
